...
All the images have been resized to 224x224 so that each image sample has the same matrix size while training the data.
...
We are using top-1 accuracy and top-5 accuracy as our metrics to compare between model performances.

**Placeholder for Table with Model Metrics and Model Name**

**Placeholder for Graph of Loss vs Epochs**
